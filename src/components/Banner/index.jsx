...
export function Banner(){
  return(
    ...
    className="bg-black h-auto flex flex-col items-center justify-center space-y-14 py-24 lg:px-24">
      ...
      duration={500}
      to={"CardSobreMim"}
      className="text-white text-md bg-purple-800 px-24 py-2 rounded font-medium hover:bg-purple-700 hover:scale-105 duration-300 cursor-pointer">Conhecer mais</Link>
